...
export default function DeliciousRecipe({ title, time, part, image }) {
  return (
    ...
    >
      <div className="absolute w-[400px] h-[250px] left-[1px] top-[1px]">
        <img
          src={`/RecipesImages/DeliciousRecipes/${image}`}
          alt={title}
          className="w-[396px] h-[253px] left-[1px] bottom-[1px] 
      ...
      <div className="absolute top-[368px] left-[44px] flex gap-4">
        ...
        <span className="text-sm text-black/60 font-medium">{part}</span>
      </div>
